...
class OverrideOperator extends $pb.ProtobufEnum {
  static const OverrideOperator NO_OVERRIDE = OverrideOperator._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NO_OVERRIDE');
  static const OverrideOperator BEST = OverrideOperator._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BEST');
  static const OverrideOperator SET = OverrideOperator._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SET');
  static const OverrideOperator INCREMENT = OverrideOperator._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INCREMENT');
  static const OverrideOperator DECREMENT = OverrideOperator._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DECREMENT');

  static const $core.List<OverrideOperator> values = <OverrideOperator> [
    NO_OVERRIDE,
    BEST,
    SET,
    INCREMENT,
  ...
  static final $core.Map<$core.int, OverrideOperator> _byValue = $pb.ProtobufEnum.initByValue(values);
  static OverrideOperator? valueOf($core.int value) => _byValue[value];

  const OverrideOperator._($core.int v, $core.String n) : super(v, n);
}
