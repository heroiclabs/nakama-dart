...
const Envelope$json = const {
  ...
  '2': const [
    ...
    const {'1': 'party', '3': 34, '4': 1, '5': 11, '6': '.nakama.realtime.Party', '9': 0, '10': 'party'},
    const {'1': 'party_create', '3': 35, '4': 1, '5': 11, '6': '.nakama.realtime.PartyCreate', '9': 0, '10': 'partyCreate'},
    const {'1': 'party_join', '3': 36, '4': 1, '5': 11, '6': '.nakama.realtime.PartyJoin', '9': 0, '10': 'partyJoin'},
    const {'1': 'party_leave', '3': 37, '4': 1, '5': 11, '6': '.nakama.realtime.PartyLeave', '9': 0, '10': 'partyLeave'},
    const {'1': 'party_promote', '3': 38, '4': 1, '5': 11, '6': '.nakama.realtime.PartyPromote', '9': 0, '10': 'partyPromote'},
    const {'1': 'party_leader', '3': 39, '4': 1, '5': 11, '6': '.nakama.realtime.PartyLeader', '9': 0, '10': 'partyLeader'},
    const {'1': 'party_accept', '3': 40, '4': 1, '5': 11, '6': '.nakama.realtime.PartyAccept', '9': 0, '10': 'partyAccept'},
    const {'1': 'party_remove', '3': 41, '4': 1, '5': 11, '6': '.nakama.realtime.PartyRemove', '9': 0, '10': 'partyRemove'},
    const {'1': 'party_close', '3': 42, '4': 1, '5': 11, '6': '.nakama.realtime.PartyClose', '9': 0, '10': 'partyClose'},
    const {'1': 'party_join_request_list', '3': 43, '4': 1, '5': 11, '6': '.nakama.realtime.PartyJoinRequestList', '9': 0, '10': 'partyJoinRequestList'},
    const {'1': 'party_join_request', '3': 44, '4': 1, '5': 11, '6': '.nakama.realtime.PartyJoinRequest', '9': 0, '10': 'partyJoinRequest'},
    const {'1': 'party_matchmaker_add', '3': 45, '4': 1, '5': 11, '6': '.nakama.realtime.PartyMatchmakerAdd', '9': 0, '10': 'partyMatchmakerAdd'},
    const {'1': 'party_matchmaker_remove', '3': 46, '4': 1, '5': 11, '6': '.nakama.realtime.PartyMatchmakerRemove', '9': 0, '10': 'partyMatchmakerRemove'},
    const {'1': 'party_matchmaker_ticket', '3': 47, '4': 1, '5': 11, '6': '.nakama.realtime.PartyMatchmakerTicket', '9': 0, '10': 'partyMatchmakerTicket'},
    const {'1': 'party_data', '3': 48, '4': 1, '5': 11, '6': '.nakama.realtime.PartyData', '9': 0, '10': 'partyData'},
    const {'1': 'party_data_send', '3': 49, '4': 1, '5': 11, '6': '.nakama.realtime.PartyDataSend', '9': 0, '10': 'partyDataSend'},
    const {'1': 'party_presence_event', '3': 50, '4': 1, '5': 11, '6': '.nakama.realtime.PartyPresenceEvent', '9': 0, '10': 'partyPresenceEvent'},
  ],
  '8': const [
    const {'1': 'message'},
  ],
...
final $typed_data.Uint8List envelopeDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List matchmakerMatchedDescriptor = $convert.base64Decode('');
...
const Party$json = const {
  ...
  '2': const [
    ...
    const {'1': 'self', '3': 4, '4': 1, '5': 11, '6': '.nakama.realtime.UserPresence', '10': 'self'},
    const {'1': 'leader', '3': 5, '4': 1, '5': 11, '6': '.nakama.realtime.UserPresence', '10': 'leader'},
    const {'1': 'presences', '3': 6, '4': 3, '5': 11, '6': '.nakama.realtime.UserPresence', '10': 'presences'},
  ],
};

/// Descriptor for `Party`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List partyDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List partyCreateDescriptor = $convert.base64Decode('CgtQYXJ0eUNyZWF0ZRISCgRvcGVuGAEgASgIUgRvcGVuEhkKCG1heF9zaXplGAIgASgFUgdtYXhTaXpl');
...
final $typed_data.Uint8List partyJoinDescriptor = $convert.base64Decode('CglQYXJ0eUpvaW4SGQoIcGFydHlfaWQYASABKAlSB3BhcnR5SWQ=');
...
final $typed_data.Uint8List partyLeaveDescriptor = $convert.base64Decode('CgpQYXJ0eUxlYXZlEhkKCHBhcnR5X2lkGAEgASgJUgdwYXJ0eUlk');
...
final $typed_data.Uint8List partyPromoteDescriptor = $convert.base64Decode('CgxQYXJ0eVByb21vdGUSGQoIcGFydHlfaWQYASABKAlSB3BhcnR5SWQSOQoIcHJlc2VuY2UYAiABKAsyHS5uYWthbWEucmVhbHRpbWUuVXNlclByZXNlbmNlUghwcmVzZW5jZQ==');
...
final $typed_data.Uint8List partyLeaderDescriptor = $convert.base64Decode('CgtQYXJ0eUxlYWRlchIZCghwYXJ0eV9pZBgBIAEoCVIHcGFydHlJZBI5CghwcmVzZW5jZRgCIAEoCzIdLm5ha2FtYS5yZWFsdGltZS5Vc2VyUHJlc2VuY2VSCHByZXNlbmNl');
...
final $typed_data.Uint8List partyAcceptDescriptor = $convert.base64Decode('CgtQYXJ0eUFjY2VwdBIZCghwYXJ0eV9pZBgBIAEoCVIHcGFydHlJZBI5CghwcmVzZW5jZRgCIAEoCzIdLm5ha2FtYS5yZWFsdGltZS5Vc2VyUHJlc2VuY2VSCHByZXNlbmNl');
...
final $typed_data.Uint8List partyRemoveDescriptor = $convert.base64Decode('CgtQYXJ0eVJlbW92ZRIZCghwYXJ0eV9pZBgBIAEoCVIHcGFydHlJZBI5CghwcmVzZW5jZRgCIAEoCzIdLm5ha2FtYS5yZWFsdGltZS5Vc2VyUHJlc2VuY2VSCHByZXNlbmNl');
...
final $typed_data.Uint8List partyCloseDescriptor = $convert.base64Decode('CgpQYXJ0eUNsb3NlEhkKCHBhcnR5X2lkGAEgASgJUgdwYXJ0eUlk');
...
final $typed_data.Uint8List partyJoinRequestListDescriptor = $convert.base64Decode('ChRQYXJ0eUpvaW5SZXF1ZXN0TGlzdBIZCghwYXJ0eV9pZBgBIAEoCVIHcGFydHlJZA==');
...
final $typed_data.Uint8List partyJoinRequestDescriptor = $convert.base64Decode('ChBQYXJ0eUpvaW5SZXF1ZXN0EhkKCHBhcnR5X2lkGAEgASgJUgdwYXJ0eUlkEjsKCXByZXNlbmNlcxgCIAMoCzIdLm5ha2FtYS5yZWFsdGltZS5Vc2VyUHJlc2VuY2VSCXByZXNlbmNlcw==');
...
const PartyMatchmakerAdd$json = const {
  ...
  '2': const [
    ...
    const {'1': 'string_properties', '3': 5, '4': 3, '5': 11, '6': '.nakama.realtime.PartyMatchmakerAdd.StringPropertiesEntry', '10': 'stringProperties'},
    const {'1': 'numeric_properties', '3': 6, '4': 3, '5': 11, '6': '.nakama.realtime.PartyMatchmakerAdd.NumericPropertiesEntry', '10': 'numericProperties'},
  ],
  '3': const [PartyMatchmakerAdd_StringPropertiesEntry$json, PartyMatchmakerAdd_NumericPropertiesEntry$json],
};
...
final $typed_data.Uint8List partyMatchmakerAddDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List partyMatchmakerRemoveDescriptor = $convert.base64Decode('ChVQYXJ0eU1hdGNobWFrZXJSZW1vdmUSGQoIcGFydHlfaWQYASABKAlSB3BhcnR5SWQSFgoGdGlja2V0GAIgASgJUgZ0aWNrZXQ=');
...
final $typed_data.Uint8List partyMatchmakerTicketDescriptor = $convert.base64Decode('ChVQYXJ0eU1hdGNobWFrZXJUaWNrZXQSGQoIcGFydHlfaWQYASABKAlSB3BhcnR5SWQSFgoGdGlja2V0GAIgASgJUgZ0aWNrZXQ=');
...
final $typed_data.Uint8List partyDataDescriptor = $convert.base64Decode('CglQYXJ0eURhdGESGQoIcGFydHlfaWQYASABKAlSB3BhcnR5SWQSOQoIcHJlc2VuY2UYAiABKAsyHS5uYWthbWEucmVhbHRpbWUuVXNlclByZXNlbmNlUghwcmVzZW5jZRIXCgdvcF9jb2RlGAMgASgDUgZvcENvZGUSEgoEZGF0YRgEIAEoDFIEZGF0YQ==');
...
final $typed_data.Uint8List partyDataSendDescriptor = $convert.base64Decode('Cg1QYXJ0eURhdGFTZW5kEhkKCHBhcnR5X2lkGAEgASgJUgdwYXJ0eUlkEhcKB29wX2NvZGUYAiABKANSBm9wQ29kZRISCgRkYXRhGAMgASgMUgRkYXRh');
...
final $typed_data.Uint8List partyPresenceEventDescriptor = $convert.base64Decode('ChJQYXJ0eVByZXNlbmNlRXZlbnQSGQoIcGFydHlfaWQYASABKAlSB3BhcnR5SWQSMwoFam9pbnMYAiADKAsyHS5uYWthbWEucmVhbHRpbWUuVXNlclByZXNlbmNlUgVqb2lucxI1CgZsZWF2ZXMYAyADKAsyHS5uYWthbWEucmVhbHRpbWUuVXNlclByZXNlbmNlUgZsZWF2ZXM=');
