...
final $typed_data.Uint8List overrideOperatorDescriptor = $convert.base64Decode(
    'ChBPdmVycmlkZU9wZXJhdG9yEg8KC05PX09WRVJSSURFEAASCAoEQkVTVBABEgcKA1NFVBACEg0KCUlOQ1JFTUVOVBADEg0KCURFQ1JFTUVOVBAE');
...
final $typed_data.Uint8List listGroupsRequestDescriptor = $convert.base64Decode(
    'ChFMaXN0R3JvdXBzUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEhYKBmN1cnNvchgCIAEoCVIGY3Vyc29yEjEKBWxpbWl0GAMgASgLMhsuZ29vZ2xlLnByb3RvYnVmLkludDMyVmFsdWVSBWxpbWl0');
...
final $typed_data.Uint8List tournamentDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List writeLeaderboardRecordRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List writeTournamentRecordRequestDescriptor =
    $convert.base64Decode(
        '');
