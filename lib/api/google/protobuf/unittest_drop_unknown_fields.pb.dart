...
class FooWithExtraFields extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<FooWithExtraFields_NestedEnum>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enumValue', $pb.PbFieldType.OE,
    ...
    ..a<$core.int>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'extraInt32Value',
        $pb.PbFieldType.O3)
    ..hasRequiredFields = false;
