...
class TestAllTypesLite extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(48)
  $core.List<TestAllTypesLite_NestedMessage> get repeatedNestedMessage => $_getList(42);
  ...
  @$pb.TagNumber(51)
  $core.List<TestAllTypesLite_NestedEnum> get repeatedNestedEnum => $_getList(45);
  ...
  @$pb.TagNumber(57)
  $core.List<TestAllTypesLite_NestedMessage> get repeatedLazyMessage => $_getList(50);
  ...
  @$pb.TagNumber(116)
  set deceptivelyNamedList($core.int v) { $_setSignedInt32(76, v); }
  @$pb.TagNumber(116)
