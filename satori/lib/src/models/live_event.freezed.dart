...
/// Adds pattern-matching-related methods to [LiveEventList].
extension LiveEventListPatterns on LiveEventList {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LiveEventList value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LiveEventList() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<LiveEvent> liveEvents)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LiveEventList() when $default != null:
        return $default(_that.liveEvents);
      case _:
        return orElse();
    }
  }
...
extension LiveEventPatterns on LiveEvent {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LiveEvent value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? activeEndTimeSec, String? activeStartTimeSec,
    ...
    switch (_that) {
      case _LiveEvent() when $default != null:
        return $default(_that.activeEndTimeSec, _that.activeStartTimeSec,
            _that.description, _that.name, _that.value);
      case _:
        return orElse();
    }
  }
