...
extension SessionPatterns on Session {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String token, String refreshToken, String identityId,
            DateTime expiresAt, DateTime refreshExpiresAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Session() when $default != null:
        return $default(_that.token, _that.refreshToken, _that.identityId,
            _that.expiresAt, _that.refreshExpiresAt);
      case _:
        return orElse();
    }
  }
