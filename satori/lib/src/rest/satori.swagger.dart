...
class ApiAuthenticateLogoutRequest {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is ApiAuthenticateLogoutRequest &&
...
extension $ApiAuthenticateLogoutRequestExtension
...
extension $ApiAuthenticateRefreshRequestExtension
...
class ApiExperimentList {
  ...
  @override
  int get hashCode =>
      const DeepCollectionEquality().hash(experiments) ^ runtimeType.hashCode;
}
...
class ApiLiveEventList {
  ...
  @override
  int get hashCode =>
      const DeepCollectionEquality().hash(liveEvents) ^ runtimeType.hashCode;
}
...
class ApiUpdatePropertiesRequest {
  ...
  int get hashCode =>
      const DeepCollectionEquality().hash($default) ^
      const DeepCollectionEquality().hash(custom) ^
      const DeepCollectionEquality().hash(recompute) ^
      runtimeType.hashCode;
}
